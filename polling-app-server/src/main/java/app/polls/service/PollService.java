package app.polls.service;

import app.polls.exception.BadRequestException;
import app.polls.exception.ResourceNotFoundException;
import app.polls.model.*;
import app.polls.payload.request.PollRequest;
import app.polls.payload.request.VoteRequest;
import app.polls.payload.response.PagedResponse;
import app.polls.payload.response.PollResponse;
import app.polls.repository.PollRepository;
import app.polls.repository.UserRepository;
import app.polls.repository.VoteRepository;
import app.polls.security.UserPrincipal;
import app.polls.util.AppConstants;
import app.polls.util.ModelMapper;
